...
This repository is the official implementation of our paper, **"RONet: Enhanced RGB-T Salient Object Detection via Recurrent Optimization Network"**, submitted to *The Visual Computer*.
...
<div align=center>
  <img src="https://github.com/IMOP-lab/RONet/blob/main/figures/compare.png">
</div>
...
```
@article{sun2025ronet,
  title={RONet: Enhanced RGB-T Salient Object Detection via Recurrent Optimization Network},
  author={Yaoqi Sun and Zhaoyang Xu and Zhao Huang and Gaopeng Huang and Bin Wan and Haibing Yin and Jin Liu and Zhiwen Zheng and Xiaoshuai Zhang and Xingru Huang},
